...
def stm_sct():
    '''
    write the result to the _src_stm_sct.txt
    只选择高斯核函数一种进行学习
    '''
# for i, clf in enumerate((clf_linear, clf_poly, clf_rbf, clf_sigmoid)):
    ...
    output = open("SVM\\Result\\_src_stm_sct.txt", "w")
    '''
    write the result to the _src_stm_sct.txt
    '''
    output.writelines('_src_stm_sct:  ')
